...
function google(file_1,file_2,type_1,type_2,image,set_first){
	if(image == true){
		...
		var file = file_1;
		var type = type_1;
		var quality = '<div class="change_hd"><div class="change_content"><span onclick="changer_quality.call(this)" data="mhd" class="m_hd box_change active">B?n Thu?ng</span><span onclick="changer_quality.call(this)" data="hd" class="full_hd box_change">B?n Ð?p</span></div></div>';
	}
	var video = '<video id="vd_google" class="markai_vd video-js vjs-default-skin"  controls preload="auto"  height="264" poster="'+image+'" data-setup=\'\{"example_option"\:true,"language":"vi"\}\'>';
  	...
  	video += '<p class="vjs-no-js">Ð? xem video này, hãy b?t JavaScript, ho?c nâng c?p lên m?t trình duy?t web h? tr? HTML5 video</video>';
	if(set_first == true){
		$('.mobile_video.phimhd').before(video);
